 ...
 * inside app-ds components or in consumer code — defaults to strokeWidth=1
 * (Lucide's own default is 2) without each usage having to pass it
 * explicitly. Import icons directly from "lucide-react-native"; this only
 * sets the shared default, it doesn't re-export the icon set.
 */
